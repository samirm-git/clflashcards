...
//REMOVE RUNHELP FROM COMMAND STRUCT
//INSTEAD CREATE ANOTHER HELP STRUCT
//SOMEHOW MAKE IT SO THAT ANY NEW COMMANDS ADDED TO THE COMMAND STRUCT MUST HAVE A CORRESPONDING HELP ENTRY
type Command struct {
	Name        string
	Description string
